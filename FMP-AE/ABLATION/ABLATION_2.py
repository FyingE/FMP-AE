...
from model import create_windows, Autoencoder, plot_loss_values, \
    ...
    plot_detected_anomalies, expand_anomalies, plot_reconstruct_error, plot_roc_curve, plot_pr_curve
...
# 读取示例文件，获取时间序列数据
file_path_example = 'UCR_Anomaly_FullData/020_UCR_Anomaly_DISTORTEDGP711MarkerLFM5z2_5000_7175_7388.txtt'
...
expanded_predicted_labels = expand_anomalies(predicted_labels_recon_error, window_size=window_size)
